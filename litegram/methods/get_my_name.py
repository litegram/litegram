...
class GetMyName(TelegramMethod[BotName]):
    """
    Use this method to get the current bot name for the given user language. Returns :class:`litegram.types.bot_name.BotName` on success.
    ...
    if TYPE_CHECKING:
        ...
        def __init__(__pydantic__self__, *, language_code: str | None = None, **__pydantic_kwargs: Any) -> None:
            # DO NOT EDIT MANUALLY!!!
