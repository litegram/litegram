...
class KeyboardButtonRequestUsers(TelegramObject):
    ...
    request_id: int
    """Signed 32-bit identifier of the request that will be received back in the :class:`litegram.types.users_shared.UsersShared` object. Must be unique within the message"""
