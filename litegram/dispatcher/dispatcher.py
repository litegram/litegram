...
from litegram.fsm.middleware import FSMContextMiddleware
from litegram.fsm.storage.base import BaseEventIsolation, BaseStorage
from litegram.fsm.storage.memory import DisabledEventIsolation, MemoryStorage
from litegram.fsm.strategy import FSMStrategy
from litegram.methods import GetUpdates, TelegramMethod
from litegram.types import Update, User
from litegram.types.base import UNSET, UNSET_TYPE
from litegram.types.update import UpdateTypeLookupError
from litegram.utils.backoff import Backoff, BackoffConfig
...
class Dispatcher(Router):
    ...
    async def _listen_update(self, update: Update, **kwargs: Any) -> Any:
        ...
        try:
            ...
            warnings.warn(
                ...
                "installed not latest version of litegram framework"
    ...
    async def feed_webhook_update[TelegramType](
        self,
        bot: Bot,
    ...
    async def start_polling(
        ...
        **kwargs: Any,
        ...
        if "bot" in kwargs:
            msg = "Keyword argument 'bot' is not acceptable, the bot instance should be passed as positional argument"
            raise ValueError(msg)
