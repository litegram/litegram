...
from litegram.fsm.storage.base import DEFAULT_DESTINY, DefaultKeyBuilder, StorageKey
...
class TestDefaultKeyBuilder:
    @pytest.mark.parametrize(
        ...
        [
            ...
            [
                DefaultKeyBuilder(prefix=PREFIX, with_bot_id=True, with_business_connection_id=True),
                FIELD,
            ...
            [
                DefaultKeyBuilder(prefix=PREFIX, with_destiny=True, with_business_connection_id=True),
                FIELD,
    ...
    async def test_destiny_check(self):
        ...
        key = StorageKey(chat_id=CHAT_ID, user_id=USER_ID, bot_id=BOT_ID, destiny="CUSTOM_TEST_DESTINY")
