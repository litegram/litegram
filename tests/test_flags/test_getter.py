...
from litegram.dispatcher.flags import (
    check_flags,
    extract_flags,
...
class TestGetters:
    def test_extract_flags_from_object(self):
        ...
        func.litegram_flag = {"test": True}
        assert extract_flags_from_object(func) == func.litegram_flag
    ...
    def test_check_flag(self, flags, magic, result):
        with patch("litegram.dispatcher.flags.extract_flags", return_value=flags):
