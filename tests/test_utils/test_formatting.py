...
from litegram.enums import MessageEntityType
from litegram.types import MessageEntity, User
...
from litegram.utils.text_decorations import html_decoration
...
class TestUtils:
    def test_apply_entity(self):
        node = _apply_entity(MessageEntity(type=MessageEntityType.BOLD, offset=0, length=4), "test")
