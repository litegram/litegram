...
from litegram.enums import ChatType, MessageEntityType, ParseMode
from litegram.methods import SendMessage
from litegram.types import Chat, LinkPreviewOptions, Message, MessageEntity, User
from litegram.utils.serialization import (
...
class TestSerialize:
    ...
    def test_deserialize_default(self):
        ...
        with pytest.raises(PydanticSerializationError):
            # https://github.com/litegram/litegram/issues/1450
