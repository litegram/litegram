...
from litegram.types import Update, User
from litegram.utils.i18n import (
    ConstI18nMiddleware,
    FSMI18nMiddleware,
    I18n,
...
class TestI18nCore:
    def test_init(self, i18n: I18n):
        assert set(i18n.available_locales) == {"en", "ru"}

    def test_init_relative(self):
        i18n_relative = I18n(path="tests/data/locales")
        assert set(i18n_relative.available_locales) == {"en", "ru"}
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            [None, {"singular": "test", "locale": "ru"}, "тест"],
            ["en", {"singular": "test", "locale": "ru"}, "тест"],
            ["ru", {"singular": "test", "locale": "ru"}, "тест"],
            ["ru", {"singular": "test"}, "тест"],
            ["it", {"singular": "test"}, "test"],
            [None, {"singular": "test", "n": 2}, "test"],
            [None, {"singular": "test", "n": 2, "locale": "ru"}, "тест"],
            ["en", {"singular": "test", "n": 2, "locale": "ru"}, "тест"],
            ["ru", {"singular": "test", "n": 2, "locale": "ru"}, "тест"],
            ["ru", {"singular": "test", "n": 2}, "тест"],
            ["it", {"singular": "test", "n": 2}, "test"],
            [None, {"singular": "test", "plural": "test2", "n": 2}, "test2"],
            [None, {"singular": "test", "plural": "test2", "n": 2, "locale": "ru"}, "test2"],
            ["en", {"singular": "test", "plural": "test2", "n": 2, "locale": "ru"}, "test2"],
            ["ru", {"singular": "test", "plural": "test2", "n": 2, "locale": "ru"}, "test2"],
            ["ru", {"singular": "test", "plural": "test2", "n": 2}, "test2"],
...
class TestSimpleI18nMiddleware:
    ...
    async def test_custom_keys(self, i18n: I18n):
        ...
        middleware = SimpleI18nMiddleware(i18n=i18n, i18n_key="translator", middleware_key="middleware")
...
class TestConstI18nMiddleware:
    ...
    async def test_middleware(self, i18n: I18n):
        middleware = ConstI18nMiddleware(i18n=i18n, locale="ru")
        result = await middleware(
            next_call,
            Update(update_id=42),
            {
...
class TestFSMI18nMiddleware:
    ...
    async def test_middleware(self, i18n: I18n, bot: MockedBot):
        ...
        await middleware.set_locale(state, "ru")
        assert i18n.current_locale == "ru"
