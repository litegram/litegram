...
from litegram.utils.token import TokenValidationError, extract_bot_id, validate_token
...
class TestExtractBotId:
    def test_extract_bot_id(self):
        with patch("litegram.utils.token.validate_token") as mocked_validate_token:
