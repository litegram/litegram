...
from litegram.dispatcher.event.handler import FilterObject
from litegram.filters import StateFilter
...
class TestStateFilter:
    ...
    def test_validator(self, state):
        ...
        value = f.states[0]
        assert isinstance(value, (State, str, MyGroup)) or (isclass(value) and issubclass(value, StatesGroup)) or value is None
